      ...
      <div>
        {medicalRecordError || medicalRecordLoading ? (
          ...
          <div className="ml-[-1rem] flex flex-row justify-evenly mt-5 mx-52 px-10 py-5">
            ...
            <div className=' ml-10 h-52  bg-white w-64 flex flex-row justify-center space-x-2 border-4 border-purple-200 rounded-3xl'>
              <div className='flex items-center'>
                <div className='bg-purple-200 h-20 w-20 my-3  mx-3 flex items-center justify-center rounded-full'>
                  <svg width="54px" height="54px" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M21.3702 39.6334L21.3709 39.6341L24.0013 42L26.6294 39.654L26.6306 39.653L26.6836 39.6055L26.6846 39.6046C26.9072 39.4048 27.1281 39.2064 27.3474 39.0095C24.7134 37.1017 23 34.0009 23 30.5C23 24.701 27.701 20 33.5 20C36.8352 20 39.8071 21.555 41.7305 23.9794C43.2111 21.5454 44 19.164 44 16.6404C44 10.6778 39.2655 6 33.2308 6C29.8168 6 26.5322 7.57272 24.3905 10.0577L24 10.5107L23.6095 10.0577C21.4678 7.57272 18.1832 6 14.7692 6C8.7345 6 4 10.6778 4 16.6404C4 20.3045 5.6632 23.6688 8.69183 27.3273C11.7264 30.993 16.0777 34.8917 21.3702 39.6334Z" fill="#eb5ff5" />
                    <path fillRule="evenodd" clipRule="evenodd" d="M33.5 39C38.1944 39 42 35.1944 42 30.5C42 25.8056 38.1944 22 33.5 22C28.8056 22 25 25.8056 25 30.5C25 35.1944 28.8056 39 33.5 39ZM33.5 41C39.299 41 44 36.299 44 30.5C44 24.701 39.299 20 33.5 20C27.701 20 23 24.701 23 30.5C23 36.299 27.701 41 33.5 41Z" fill="#333333" />
                    <path d="M36 30.5C36 31.8807 34.8807 33 33.5 33C32.1193 33 31 31.8807 31 30.5C31 29.1193 32.1193 28 33.5 28C34.8807 28 36 29.1193 36 30.5Z" fill="#333333" />
                    <path d="M28.3219 26.9432C27.9292 26.5505 27.9292 25.9138 28.3219 25.5211C28.7146 25.1284 29.3513 25.1284 29.744 25.5211L33.9788 29.7558C34.3715 30.1486 34.3715 30.7853 33.9788 31.178C33.586 31.5707 32.9493 31.5707 32.5566 31.178L28.3219 26.9432Z" fill="#333333" />
                  </svg>
                </div>
              </div>
              <div className='flex flex-col justify-center text-center'>
                {medicalRecordData && (<h3>{medicalRecordData.diaMmHg} mmHg</h3>)}
                <h5>Diastolic </h5>
              </div>
            </div>
